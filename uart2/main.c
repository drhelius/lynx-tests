...
static const expected_result_t k_expected_results[RESULT_COUNT] =
{
    ...
    EXPECT(0x00), EXPECT(0x00), EXPECT(0x00), EXPECT(0x00), EXPECT(0x00),
...
static const uint8_t k_test_offsets[TEST_COUNT] = { 0, 2, 7, 11, 12 };
static const uint8_t k_test_counts[TEST_COUNT]  = { 2, 5, 4, 1,  1  };
