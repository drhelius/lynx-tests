...
{
    EXPECT(0x00),                   /*  0 echo latency in us (raw)      */
    EXPECT(0x00),                   /*  1 echo latency in range         */
    EXPECT(0x00),                   /*  2 echo gap in us (raw)          */
    EXPECT(0x00),                   /*  3 echo gap in range             */
    EXPECT(0x07),                   /*  4 burst echo byte count         */
    EXPECT(0x01),                   /*  5 burst echo mismatches         */
    EXPECT(0x01),                   /*  6 burst echo overrun            */
    EXPECT(0x00),                   /*  7 echo ready before next TXRDY  */
    EXPECT(0x00),                   /*  8 slow reader byte count (raw)  */
    EXPECT(0x01),                   /*  9 slow reader overran           */
    EXPECT(0x00),                   /* 10 parity echo odd               */
    EXPECT(0x00),                   /* 11 parity echo even              */
    EXPECT(0x00),                   /* 12 ninth bit echo low            */
    EXPECT(0x00),                   /* 13 ninth bit echo high           */
    EXPECT(0x00),
    EXPECT(0x00),
    EXPECT(0x00),
    EXPECT(0x00),
...
static const uint8_t k_test_offsets[TEST_COUNT] = { 1, 3, 4, 7, 9, 10 };
static const uint8_t k_test_counts[TEST_COUNT]  = { 1, 1, 3, 1, 1, 4  };
